...
function sidebarColor(a) {
  ...
  SetColorMassive(color, ['card', 'card-background', 'shadow-none', 'card-background-mask-' + color], ".sidenav", "#sidenavCard", "#sidenavCardIcon");
}

function SetColorMassive(color, class_config, space_el, target_id, target_icon_id)
{
  var sidebar = document.querySelector(space_el);
  ...
  if(target_id!='')
  {
    ...
    {
      var sidenavCard = document.querySelector(target_id);
      let sidenavCardClasses = class_config;
      sidenavCard.className = '';
      sidenavCard.classList.add(...sidenavCardClasses);
    
      if(target_icon_id!='')
      {
        var sidenavCardIcon = document.querySelector(target_icon_id);
...
/* function setup() {
  var settings = localStorage.querySelector('[data-class]');
}
setup(); */
